...
public class CrosshairController : MonoBehaviour
{
    ...
    [SerializeField] private float borderCoef = 0.01f;
    ...
    public void SetCamera(Camera cam, Players playerNumber)
    {
        switch(playerNumber)
        {
            case Players.Player1:
                camera1 = cam;
                crosshair1 = new Crosshair(camera1, aimItem1, targetAimItem1, targetHoldTime, aimSpeed, rayRadius, maxDistance, borderCoef);
                break;
            case Players.Player2:
                camera2 = cam;
                crosshair2 = new Crosshair(camera2, aimItem2, targetAimItem2, targetHoldTime, aimSpeed, rayRadius, maxDistance, borderCoef);
                break;
        }
    }
